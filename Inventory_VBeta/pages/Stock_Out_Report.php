            ...
            <div class="container-fluid">
                <div class="row">
					...
					&nbsp;&nbsp;&nbsp;&nbsp; Material Issued Report
                     ...
                     <input style="width:50%;text-align:left" class="form-control"  type="text" id="datepicker1" name="datepicker1"  placeholder="dd-mm-yy" style="color:#000;"></input> 
							   </div>
							...
							<div class="form-group" id="div_datepicker" >
                              <label>To Date</label>
                               <div id="sandbox-container">
             <input  style="width:50%;text-align:left;" class="form-control"  type="text" id="datepicker2" name="datepicker2"  placeholder="dd-mm-yy" style="color:#000;"></input> 
							   </div>
...
<script src="../js/jquery-ui.js"></script>
 ...
 function gettableval(date1,date2)
 {
	 ...
	 //alert(date2);
		 ...
		 $.ajax({ 
						type: "POST",
						url: 'ajax/ajax_stock_outreport.php',
