            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="User_register.php"><i class="fa fa-user fa-fw"></i> User Registration</a></li>
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-heading">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;Material Issued Transaction
				</div>
                 <form  id="form1" name="form1" action="ajax/InsertStockOut_tran.php"  method="post" >
...
<div class="form-group">
                                 ...
                                 <select class="form-control" name="Inhouse_nm" style="color:#000;" id="Inhouse_nm" autofocus tabindex="0"  onChange="$('#item_id').attr('disabled', false);$('#datepicker').focus();" onBlur="$('#datepicker').focus();" >
...
<div class="form-group" style="display:none">
                      ...
                      <input class="form-control"  readonly name="geog_id" id="geog_id" placeholder=" "  tabindex="-1" value="<?php echo $showlocation_Id['Geog_Id'] ?>">
                                          <?php } ?>
                                        ...
                                        <input type="text" class="form-control" id="datepicker"  tabindex="1" style="text-align:left" name="datepicker" value="" placeholder="dd-mm-yy"   onKeyDown="$('#item_id').select2('focus');"  onBlur="$('#item_id').select2('focus');" >
                                              </div>                                        
                                        </div>
                                ...
                                <div class="col-lg-6">
                                  ...
                                  <?php $getTransactionNo = getStockOutTransactionNo();
                       ...
                       <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <input class="form-control" name="qty" id="qty" value=""  tabindex="3" onChange="chk_Avlqty(this.value);"></div></td>
										<td><div>
                           <input class="form-control" name="price" id="price" value="" tabindex="4"></div> </td>
  ...
  $(function() {
    $( "#datepicker" ).datepicker(
	   ...
	   function getItemName(id)
	   {
		   ...
		   var Inhouse_Id = $('#Inhouse_nm option:selected' ).val();
		  // alert(Inhouse_Id);
	 ...
	 if(selectItemId  != undefined)
	 {
	   $.ajax({ 
		 ...
		 /*$.ajax({ 
						type: "POST",
						url: 'ajax/getavl_interdep.php',
						data: {'Inhouse_Id':Inhouse_Id,'selectItemId':selectItemId},
						success: function(data){
							alert(data);
							$('#dis_avlqty_interdep').html(data);
							$('#qty').focus();
 ...
 <script>
  ...
  messages: {
	 // Geog_Id: {required: 'Select Geog ID'},
	  Inhouse_nm: {required: 'Please Select Location'},
