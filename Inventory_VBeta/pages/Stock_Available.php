...
.abc:hover{text-decoration:none;background-color:red}
</style>
</head>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;Stock In-Hand Report
                        ...
                        <div class="panel panel-default"><!--../mpdf60/examples/materialIn_Hand_pdf.php -->
                        
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                            <div id="tablestockin">
							<a href="ajax/material_Inhandexcel.php"  class="btn btn-success btn-sm" style="margin-left: 863px;float:right;">
          <span class="glyphicon glyphicon-file">Export Excel</span>
             ...
             <table class="table table-striped table-bordered table-hover" id="dataTables-example" width="100%">
                             ...
                             <tbody id="tbId">
                                      <?php $getitemdetils = getitemnamesed();
									  $i=1;
									   while($itemavail = $getitemdetils->fetch()){
                                       ?>
                                            <tr class="odd gradeX">                                           <td><?php echo $i; ?></td>
                                            <td><?php echo $itemavail['Item_Name']; ?></td>
                                            <td><?php echo $itemavail['Available_Qty']; ?></td>
                                             </tr>    
